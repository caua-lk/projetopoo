...
SizeCommom = (96,96)
Death_Sound = pygame.mixer.Sound("Sounds/Explosion-Song.wav")

Alien_simple_image = pygame.image.load("sprites/inimigo_simple_def.png").convert_alpha()
...
Alien_seach_image = pygame.image.load("sprites/inimigo_search_def.png").convert_alpha()
...
Alien_gun_image = pygame.image.load("sprites/inimigo_gunner_def.png").convert_alpha()
