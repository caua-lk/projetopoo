...
Penguim_image = pygame.image.load("Jogo/sprites/NavePinguimDEF.png").convert_alpha()
Penguim_image = pygame.transform.scale(Penguim_image, SizeComom)

Ravage_image = pygame.image.load("Jogo/sprites/NaveRavage.png").convert_alpha()
Ravage_image = pygame.transform.scale(Ravage_image, SizeComom)

Guns_Shot_image = pygame.image.load("Jogo/sprites/NaveGunsShotDEF.png").convert_alpha()
Guns_Shot_image = pygame.transform.scale(Guns_Shot_image, SizeComom)

Tank_image = pygame.image.load("Jogo/sprites/NaveWar.png").convert_alpha()
Tank_image = pygame.transform.scale(Tank_image, SizeComom)

Sniper_image = pygame.image.load("Jogo/sprites/NaveSniper.png").convert_alpha()
Sniper_image = pygame.transform.scale(Sniper_image, SizeComom)

Shield_image = pygame.image.load('Jogo/sprites/Shield.png').convert_alpha()
raio = max(SizeComom) // 2 + 10
Shield_image = pygame.transform.scale(Shield_image, (raio*2, raio*2))
Shield_image.set_alpha(180)
# --------------------- Classe de Naves ---------------------
...
class navebase:
    ...
    def Desenhar_nave(self, tela):
        ...
        if self.shield and time.time() < self.shield_endTime:
            ...
            tela.blit(Shield_image, Shield_rect)
